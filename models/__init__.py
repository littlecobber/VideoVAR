...
from .videoquant import VectorQuantizer3
from .vqvae import VQVAE
from .videovqvae import VQVideoVAE
from .dino import DinoDisc
from .basic_vae import CNNEncoder
from .basic_videovae import CNNVideoEncoder


def build_video_vae_disc(args: Args) -> Tuple[VQVideoVAE, DinoDisc]:
    ...
    if isinstance(vae.encoder, CNNVideoEncoder):
